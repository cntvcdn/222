...
var stui = {
	...
	'mobile': {
		'headroom': function() {
			$.getScript("//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/js/headroom.min.js", function() {
				$("#header-top", function() {
		...
		'slide': function() {
			$.getScript("//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/js/flickity.pkgd.min.js", function() {
	...
	'images': {
		'lazyload': function() {
			$.getScript("//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/js/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 300,
					failurelimit: 15,
		...
		'qrcode': function() {
			$("img.qrcode").attr("//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/img/look.png")
		}
	},
	'common': {
		'stylecolor': function() {
	        ...
	        $(".gray-color").click(function(){
	            $("link[name='skin']").attr({href:"//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/css/stui_color-gray.css"});
	            createCookie('stylecolor',"//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/css/stui_color-gray.css",365);
	        });
	        $(".gules-color").click(function(){
	            $("link[name='skin']").attr({href:"//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/css/stui_color-gules.css"});
	            createCookie('stylecolor',"//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/css/stui_color-gules.css",365);
	        }); 
	        $(".blue-color").click(function(){
	            $("link[name='skin']").attr({href:"//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/css/stui_color-blue.css"});
	            createCookie('stylecolor',"//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/css/stui_color-blue.css",365);
	        });
	        $(".green-color").click(function(){
	            $("link[name='skin']").attr({href:"//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/css/stui_color-green.css"});
	            createCookie('stylecolor',"//cdn.jsdelivr.net/gh/cntvcdn/222@1.0/css/stui_color-green.css",365);
	        }); 
